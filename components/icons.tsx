...
export const MinusSquare: React.FC<IconProps> = (props) => (
...
export const PlusSquare: React.FC<IconProps> = (props) => (
  <svg {...props} viewBox="64 -65 897 897">
    <g>
      <path
...
export const CloseSquare: React.FC<IconProps> = (props) => (
  <svg {...props} viewBox="64 -65 897 897">
    <g>
      <path
...
export default { PlusSquare, MinusSquare, CloseSquare };
